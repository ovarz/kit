<header>
  <div>
    <a href=" " class="logo smooth content_center"><img src="img/header-logo.png" /></a>
    <a href="javascript:void(0)" class="open-menu content_center"><i class="fas fa-bars"></i></a>
  </div>
</header>
...
<menu class="smooth">
  <ul>
	...
	<li class="scroll-section"><a href="#partner" class="menu-link menu-partner content_center"><h2>Partner</h2></a></li>
  </ul>
</menu>
